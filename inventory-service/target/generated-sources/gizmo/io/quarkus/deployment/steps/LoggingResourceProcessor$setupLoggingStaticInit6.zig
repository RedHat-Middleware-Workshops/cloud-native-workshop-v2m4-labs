// Class: io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit6
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit6#deploy_0
    RETURN
    ** label2
