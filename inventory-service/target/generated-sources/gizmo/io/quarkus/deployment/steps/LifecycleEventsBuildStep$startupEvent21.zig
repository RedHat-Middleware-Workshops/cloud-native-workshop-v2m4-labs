// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent21
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent21#deploy_0
    RETURN
    ** label2
